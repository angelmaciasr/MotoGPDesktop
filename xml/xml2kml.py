...
def main():
    ...
    p = []
    p.append(i)
    p.append(circuito.find('.//{http://www.uniovi.es}punto_origen/{http://www.uniovi.es}longitud_origen').text)
    p.append(circuito.find('.//{http://www.uniovi.es}punto_origen/{http://www.uniovi.es}latitud_origen').text)
    p.append(circuito.find('.//{http://www.uniovi.es}punto_origen/{http://www.uniovi.es}altitud_origen').text)
    ...
    for punto_circuito in circuito.findall('.//{http://www.uniovi.es}puntos_circuito/{http://www.uniovi.es}punto'):
        p = []
        p.append(i)

        p.append(punto_circuito.find('.//{http://www.uniovi.es}longitud_punto').text)
        p.append(punto_circuito.find('.//{http://www.uniovi.es}latitud_punto').text)
        p.append(punto_circuito.find('.//{http://www.uniovi.es}altitud_punto').text)
